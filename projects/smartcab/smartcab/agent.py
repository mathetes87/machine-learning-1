...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        state = strfy(waypoint) + "_" + inputs['light'] + "_" + strfy(inputs['left']) + "_" +  strfy(inputs['oncoming'])+ "_" +  strfy(inputs['right'])
...
def run():
    ...
    sim = Simulator(env, update_delay=0.01, log_metrics=True, optimized=agent.optimized)
